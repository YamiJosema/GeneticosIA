...
#Se crean los enlaces de los estados al pais
...
G.add_edge("Miguel Peniaa","Valencia")
...
#Se muestra informacion de los nodos (cantidad, nodos)

print "Nodos: ", G.number_of_nodes(), G.nodes()

#SE muestra informacion de los enlaces (cantidad, enlaces)
